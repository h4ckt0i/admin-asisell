...
function PartnerAddition() {
  ...
  const addNewPartner = () => {
    ...
    addPartner().then((result) => {
      result
        ? successfulToast("Thêm đối tác thành công")
        : errorToast("Thêm đối tác không thành công");
      setIsLoading(false);
      setIsDisabled(false);
    });
  };
...
export default PartnerAddition;
